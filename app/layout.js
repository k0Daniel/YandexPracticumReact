				...
				<main className='main'>
					<section className='banner'>
						<div className='banner__description'>
							<h1 className='banner__title'>Портал инди-игр от&nbsp;студентов Яндекс Практикума</h1>
								...
								<a href='/game-id.html' className='card-list__link'>
									<article className='card'>
										...
										<div className='card__content-block'>
											...
											<p className='card__description'>
												Защищай магический кристалл от монстров и уничтожай кладбища, чтобы спасти Землю, которую
												поглотил мрак.
											</p>
											<div className='card__info-container'>
												<p className='card__author'>
