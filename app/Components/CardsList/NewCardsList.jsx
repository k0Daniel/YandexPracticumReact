				...
				<ul class='cards-list'>
					<li class='cards-list__item'>
						<a href='/game-id.html' class='card-list__link'>
							<article class='card'>
								<img src='https://code.s3.yandex.net/teens/pindie-games/go-away/cover.jpg' alt='' class='card__image' />
					...
					<li class='cards-list__item'>
						<a href='/game-id.html' class='card-list__link'>
							<article class='card'>
								<img src='https://code.s3.yandex.net/teens/pindie-games/gunner/cover.png' alt='' class='card__image' />
								<div class='card__content-block'>
